%% Function Definition
function InitialState(T1,P1,e1,gas1)
...
eqv_ratio= sprintf('H2:%d O2:%d',eq(1,1),eq(2,1)); %eqv ratio as percentage
...
set(gas1,'Temperature',T1,'Pressure',P1,'MoleFractions',eqv_ratio);