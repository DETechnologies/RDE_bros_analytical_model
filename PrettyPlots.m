%%The idea for this script is to generate "pretty plots" that are easy to look at -- ie dont have multiple solutions
%%because we varied other parameters, etc..... this place is for plotting ONLY one thing we want to show for a narrow range of params.
...
%% How data is stored (identical to calculator)
